...
os.makedirs(os.path.join('bayesian_optimizer', 'microxs_and_flux'), exist_ok=True)
os.makedirs(os.path.join('bayesian_optimizer', 'depletion_results'), exist_ok=True)
...
flux, microxs = openmc.deplete.get_microxs_and_flux(
    ...
    run_kwargs={'cwd': 'bayesian_optimizer'},
    path_statepoint=os.path.join('bayesian_optimizer', 'microxs_and_flux', 'microxs_statepoint.10.h5'),
)
...
N_ITERATIONS = 100  # demonstration only
